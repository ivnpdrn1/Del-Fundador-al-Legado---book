...
| Capítulo 18 | **Escrito (3.17B)**, 2.175 palabras (objetivo 2.200): **−1,1 %**, por debajo del objetivo y muy dentro del tope. **Es el capítulo que estrena D-079** y el segundo consecutivo **sin ninguna afirmación con fuente**. Produce **C-13** y el **Plan de delegación por bloques**, entregable interno |
...
| Palabras del manuscrito | **43.404**. Suma de las diecisiete piezas del libro mayor `revision/control-de-capitulos.md`, comprobada, no arrastrada |
| Objetivo del manuscrito | 45.000 – 60.000 (estimación revisada: 53.300) |
| Avance sobre el objetivo | **81,4 %** |
