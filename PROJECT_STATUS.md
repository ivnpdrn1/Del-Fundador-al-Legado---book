...
| Concepto | Valor |
|---|---|
| Piezas escritas | **17 de 27** (introducción + capítulos 1 a 16), todas en borrador |
| Capítulos terminados | **16 de 25**. **Parte I completa** (1 a 5); **Parte II completa** (6 a 10); **Parte III completa** (11 a 16). **Con el 16 queda cerrada la etapa A del método**. Lo siguiente es la Parte IV, que empieza el capítulo 17 |
...
| Palabras del manuscrito | **39.008**. Suma de las diecisiete piezas del libro mayor `revision/control-de-capitulos.md`, comprobada, no arrastrada |
| Objetivo del manuscrito | 45.000 – 60.000 (estimación revisada: 53.300) |
| Avance sobre el objetivo | **73,2 %** |
...
| Piezas del manuscrito con fuente externa | **12 de 17**: introducción y capítulos 1, 2, 5, 9, 10, 11, 12, 13, 14, 15 y **16**. **Las cinco sin ninguna referencia externa son los capítulos 3, 4, 6, 7 y 8**, por decisión razonada. |
