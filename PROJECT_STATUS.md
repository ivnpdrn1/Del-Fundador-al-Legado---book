...
| Concepto | Valor |
|---|---|
| Piezas escritas | **16 de 27** (introducción + capítulos 1 a 15), todas en borrador |
| Capítulos terminados | **15 de 25**. **Parte I completa** (1 a 5); **Parte II completa** (6 a 10); **Parte III, 5 de 6** (11 a 15). **Falta el 16 para cerrar la etapa A del método** |
