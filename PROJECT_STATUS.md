...
| Concepto | Valor |
|---|---|
| Piezas escritas | **19 de 27** (introducción + capítulos 1 a 18), todas en borrador |
| Capítulos terminados | **18 de 25**. **Partes I, II y III completas** (1 a 16); **Parte IV, 2 de 5** (17 y 18). **La etapa D tiene ya sus dos capítulos de la Parte IV**: el 17 prepara la relación y el 18 transfiere y prueba. Lo siguiente es el capítulo 19, que abre la etapa O |
...
| Palabras del manuscrito | **43.486**. Suma de las **diecinueve** piezas del libro mayor `revision/control-de-capitulos.md`, comprobada, no arrastrada |
| Objetivo del manuscrito | 45.000 – 60.000 (estimación revisada: 53.300) |
| Avance sobre el objetivo | **81,6 %** |
| Recursos terminados | **12 de 18, sin cambio en esta etapa, y es lo correcto.** El entregable del capítulo 16 no es una herramienta del catálogo (D-078) (**22.878 palabras**; no computan en el manuscrito). **Quedan seis.** **Recuento unificado el 2026-09-09:** la cifra anterior, 15.391, procedía de otro método de conteo. |
