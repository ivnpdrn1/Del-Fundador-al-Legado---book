...
| Capítulo 16 | **Escrito (3.15B)**, 2.138 palabras (objetivo 2.100). **Vuelve a la banda**: +1,8 %, muy dentro del tope del +15 % (D-030). Cierra la Parte III y la etapa A |
| Conclusión | No escrita |
| Palabras del manuscrito | **38.913**. Suma de las diecisiete piezas del libro mayor `revision/control-de-capitulos.md`, comprobada, no arrastrada |
| Objetivo del manuscrito | 45.000 – 60.000 (estimación revisada: 53.300) |
| Avance sobre el objetivo | **73,0 %** |
...
| Entregables que no son herramienta del catálogo | **4**: la **vista del proceso real** del capítulo 7 (D-070), el **Cuadro de lo que puede y lo que no puede hacer** del capítulo 12, el **Formato de recomendación explicada** del capítulo 14 y, nueva el 2026-09-09, la **Lista de comprobación de seguridad básica** del capítulo 16 —**la primera que nace ya bajo D-078**, en lugar de regularizarse después—. **Los tres viven dentro de su capítulo, no tienen archivo en `recursos/` y no alteran el catálogo**, que sigue en 18. Antes decía **2**: la fila no se actualizó al escribir el capítulo 14 |
