...
capítulo 11, de la herramienta 9 y de la primera presentación de la plataforma. **El capítulo 12
no se ha escrito y Q-17 no se ha ejecutado.**
...
| Afirmaciones con fuente en el manuscrito | **22**. **Tres nuevas en el capítulo 11** (F-038, F-040 y F-042), **las tres con el ámbito de la fuente dentro de la propia frase**: «un marco regional de referencia… que no es una ley», «en la Unión Europea», «una entrada de su blog, no una norma». **Pendiente: registrar el bloque del capítulo 11 en `editorial/05-control-de-fuentes.md`**, que no figuraba entre los archivos autorizados de la Etapa 3.10B. Antes: **19**. Seis en el capítulo 9 (F-028, F-029, F-033) y **cuatro en el capítulo 10** (F-034 y F-035), **las cuatro con el ámbito de la fuente dicho dentro de la propia frase**, incluida una que declara expresamente lo que las fuentes **no** dicen. |
