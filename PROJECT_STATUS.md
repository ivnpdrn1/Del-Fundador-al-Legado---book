...
| Capítulos terminados | **19 de 25**. **Partes I, II y III completas** (1 a 16); **Parte IV, 3 de 5** (17, 18 y 19). **El 19 abre la etapa O**, y es el primer capítulo del libro cuya letra difiere de la etapa dominante de su parte —lo que hizo visible **V-72**, que queda abierta—. Lo siguiente es el capítulo 20, **con su arquitectura aprobada el 2026-09-11 (Etapa 3.19A) y todavía sin escribir**. **Es el segundo capítulo cuya letra difiere de la de su parte**, y eso **no altera V-72**: sigue abierta, con su recomendación sin aplicar |
...
**Etapa siguiente autorizada: CAPÍTULO 20 / 3.19B — REDACCIÓN.** La arquitectura está aprobada
(Etapa 3.19A) y vive en `investigacion/plan-de-investigacion.md`. **El capítulo 20 no se escribe
sin autorización expresa del autor para abrir 3.19B.** Lo que esa etapa debe producir: el
**capítulo 20** en nueve movimientos, con la **sección de retroceso controlado** que **D-080**
aprueba y las **Reglas de intervención** **dentro del capítulo** (D-078). **No crea herramienta,
no crea C-14, no abre investigación y no toca V-72.**
