...
**Y con un resultado que detiene la etapa siguiente: V-71 requiere decisión del autor.** La línea «corrección del sistema, no de la persona» de la etapa D es **demasiado absoluta** y colisiona con **D-072** y **D-073**, que hacen que la responsabilidad sea de una persona. **La cuarta clase de error del capítulo 18 no se puede escribir mientras esa frase siga siendo universal.** Recomendación registrada: reformularla como **orden de examen** —primero la arquitectura de la transferencia, y solo después la conducta—, que **conserva íntegra su intención protectora** y cuesta una línea. **La Etapa 3.17B no empieza sin esa resolución.**
