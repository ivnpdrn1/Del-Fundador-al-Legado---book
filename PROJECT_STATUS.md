...
| Capítulo 17 | **Escrito (3.16B)**, 2.203 palabras (objetivo 2.000): **+10,2 %**, dentro del tope del +15 % (D-030). **Abre la Parte IV y la etapa D**, y es **la primera pieza desde el capítulo 8 sin ninguna afirmación con fuente**: todo lo que dice es doctrina del método o instrucción práctica |
...
| Palabras del manuscrito | **41.211**. Suma de las diecisiete piezas del libro mayor `revision/control-de-capitulos.md`, comprobada, no arrastrada |
| Objetivo del manuscrito | 45.000 – 60.000 (estimación revisada: 53.300) |
| Avance sobre el objetivo | **77,3 %** |
