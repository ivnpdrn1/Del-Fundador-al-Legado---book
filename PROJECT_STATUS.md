...
| Concepto | Valor |
|---|---|
| Piezas escritas | **18 de 27** (introducción + capítulos 1 a 17), todas en borrador |
| Capítulos terminados | **17 de 25**. **Partes I, II y III completas** (1 a 16); **Parte IV, 1 de 5** (17). **La etapa A quedó cerrada con el 16 y la etapa D queda abierta con el 17.** Lo siguiente es el capítulo 18 |
...
| Palabras del manuscrito | **41.229**. Suma de las diecisiete piezas del libro mayor `revision/control-de-capitulos.md`, comprobada, no arrastrada |
| Objetivo del manuscrito | 45.000 – 60.000 (estimación revisada: 53.300) |
| Avance sobre el objetivo | **77,4 %** |
