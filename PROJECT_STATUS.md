...
**El preflight del capítulo 13 dejó diseñados el capítulo y sus dos herramientas, y registró una sola fuente nueva.** La etapa empezó comprobando si F-007 bastaba: da la práctica —observar en condiciones parecidas al uso real, monitorizar en producción, documentar, que valide una persona, poder anular y desconectar— pero **no da el límite que el capítulo más necesita**. Ese lo da **F-045**, NIST AI 800-4 de marzo de 2026, de la misma institución: **«What is the right cadence for monitoring?» es una pregunta abierta declarada**, y las metodologías validadas de monitorización posterior al despliegue son «nascent». Con eso el libro puede negarse a dar una duración **con respaldo, en vez de por prudencia**.

**Seis constantes nuevas** fijan las fronteras del capítulo: sombra no es secreto, sombra no es entrenamiento, comparar no es imitar, no hay duración universal, alerta ≠ recomendación ≠ decisión, y «crítico» lo define el negocio. **V-67** queda abierta: nadie sabe cuándo la evidencia acumulada basta para ampliar un permiso.
