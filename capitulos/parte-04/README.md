...
Capítulos 17 a 21. **Escritos el 17, el 18 y el 19 el 2026-09-10 (Etapas 3.16B, 3.17B y 3.18B),
y el 20 el 2026-09-11 (Etapa 3.19B, sobre la arquitectura aprobada en 3.19A). Falta el 21.**
**Con el capítulo 20 quedan escritas las cuatro piezas que esta parte promete no perder:** los
límites, la capacidad de revisión, la visibilidad y los criterios de intervención.
...
| 18 | Delegación progresiva | D | **Plan de delegación por bloques — dentro del capítulo, no es una de las 18 (D-078)** | **borrador** |
| 19 | El tablero del propietario | O | Modelos de informe diario y semanal (13 y 14) | **borrador** |
| 20 | Supervisar sin intervenir en todo | O | **Reglas de intervención — dentro del capítulo, no es una de las 18 (D-078)**. **Lleva además la sección de retroceso controlado aprobada el 2026-09-11 (D-080)** | **borrador, revisado** |
