...
| 8 y 9 | **Alto** | Cap. 8 registra el motivo **en una frase**, y lo que no cabe en una frase lo aparta con la etiqueta «necesita explicación aparte». Cap. 9 desarrolla el porqué. La herramienta 6 lo repite en su propósito y en sus límites: **escribir una excepción no la transfiere**, porque falta el criterio para reconocer cuándo aplicarla. | **Sí, 2026-09-07. Sin hallazgos.** |
| 7 y 9 | **Alto** | Cap. 7 anota la **etiqueta** del criterio en una frase —«según el historial del cliente»— y para ahí. Cap. 9 lo desarrolla. La herramienta 4 lo repite en su propia columna, con un ejemplo de qué no va ahí. | **Sí, 2026-09-07. Sin hallazgos.** |
...
| Documentar el porqué, no solo el cómo. | 9 | 2, 7, 8, en una frase | Intro, cap. 1 y cap. 2, una frase cada uno. En el capítulo 2 la frase remite explícitamente a más adelante y no explica el método. **Quedan los capitulos 7 y 8.** |
...
| La advertencia «no es un instrumento validado» | **Obligatoria, no cuota.** Cada herramienta que el libro proponga la lleva la primera vez que aparece | **2** | Herramienta 1 (cap. 1) y prueba de las tres preguntas (cap. 3). **Es una obligación del proyecto, no una repetición evitable**; lo que sí debe variar es la formulación, para que no suene a fórmula. |
