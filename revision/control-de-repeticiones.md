...
| Capítulo 7 | **Una instrucción directa que pone al lector a trabajar en la primera línea**: «Coja los tres primeros elementos de su lista». Tipo no usado antes. |
| Capítulo 8 | **Continuación literal del capítulo anterior**: «Coja una de las marcas que dejó al margen». Es deliberadamente parecida a la del 7 porque el 8 continúa el mismo gesto; **es la única pareja de aperturas emparentadas del libro y no debe repetirse una tercera vez**. |
| Capítulo 9 | **Dos casos casi idénticos con desenlaces opuestos, presentados sin explicación**: dos peticiones parecidas la misma semana, un sí y un no, y la diferencia que no está escrita en ninguna parte. Tipo no usado antes. **Se eligió expresamente para no encadenar una tercera apertura del tipo «coja usted…»**, que era el riesgo tras el 7 y el 8. |
