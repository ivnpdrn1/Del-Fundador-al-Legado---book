...
| V-55 | **El continuo del retiro es lineal; la literatura describe tipos, no etapas.** F-019 identifica cuatro *tipos* de aproximación al retiro, dependientes de la experiencia previa y de circunstancias ajenas al negocio, no cuatro escalones que se recorran en orden. Nuestro continuo, ordenado de más a menos operativo, sugiere un camino de sentido único. | Antes de escribir el capítulo 5 (Etapa 3.4B) | **Abierta. Requiere decisión del autor.** No es una contradicción —ningún escalón queda desmentido—, pero sí un matiz: el continuo funciona mejor como **mapa de posiciones posibles** que como escalera. Opciones: (a) conservarlo tal cual y añadir una frase en el capítulo 5 diciendo que no hay que recorrerlo entero ni en orden; (b) reformular su presentación en `14-publico-y-rutas.md` §7. **En la Etapa 3.4A no se ha modificado nada**, por instrucción expresa. Evidencia en `plan-de-investigacion.md`, «Q-09 — Resultado», apartado 2. |
| V-56 | **Q-09 deja dos vacíos declarados.** Cero evidencia localizada de países hispanohablantes sobre retiro de personas propietarias, y casi ninguna sobre el negocio de una sola persona (solo F-023, y sobre preferencias declaradas). | Antes del capítulo 22, y al cerrar la Etapa 4 | **Abierta.** El capítulo 5 debe escribirse **sin** atribuir a la literatura nada que estas fuentes no digan, y declarando el ámbito cuando cite. Si más adelante aparece literatura hispanohablante o sobre trabajo por cuenta propia, se revisa el capítulo. |
