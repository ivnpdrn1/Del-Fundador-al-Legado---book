...
| V-57 | **La autoentrevista no tiene respaldo metodológico.** Casi toda la literatura de elicitación localizada supone **un entrevistador**: el método del incidente crítico consiste en que alguien sondee al experto (F-027), ACTA son «tres métodos de entrevista» (F-031) y elicitar implica por definición a quien elicita (F-030). El capítulo 9 va a proponer a quien trabaja solo que se entreviste a sí mismo. | Al escribir el capítulo 9 y al cerrar la Etapa 4 | **Abierta, y es una limitación declarada, no un problema por resolver.** El capítulo 9 **debe presentar la autoentrevista como diseño propio del Método LEGADO**, no como método respaldado, y debe reconocer que es más débil que una entrevista ajena, igual que ya se hace con el revisor de la herramienta 6. Si en el futuro aparece literatura de autoelicitación, se revisa. |
| V-58 | **F-028 quedó sin leer.** *Eliciting Knowledge from Experts: A Methodological Analysis* (Hoffman, Shadbolt, Burton y Klein, 1995) es la revisión metodológica central de Q-16 y no se logró abrir: Elsevier y el repositorio de Southampton devuelven error, y su registro no tiene resumen. Lo mismo ocurre con las categorías de técnicas de F-030, que su resumen no nombra. | Antes de que el libro afirme nada sobre familias de técnicas de elicitación | **Abierta.** Mientras siga así, **el capítulo 9 no puede presentar ninguna taxonomía de técnicas** ni citar F-028 para nada. Q-16 permanece resuelta solo parcialmente por este motivo. |
