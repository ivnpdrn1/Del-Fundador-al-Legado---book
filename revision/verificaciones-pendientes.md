...
| V-05 | D-005 / P-2 a P-5, ajustes de contenido en capítulos concretos. | Bloques B1, B6 y B7. | **Abierta.** **Comprobado el 2026-09-07, antes de escribir el capítulo 2: P-2 no lo afecta**, porque pide deslindar por escrito los capítulos **3 y 4** —la suposición frente a las consecuencias— y ese deslinde ya consta en `control-de-repeticiones.md` §1 y en el índice maestro. Por eso no se detuvo la producción del capítulo 2. **Sí debe resolverse antes de escribir el capítulo 3.** P-3 a P-5 siguen sin afectar al bloque en curso. |
