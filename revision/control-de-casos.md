# Control de casos ficticios

Registro obligatorio de todos los casos y personajes del libro. **Un caso se registra
aquí antes de escribirse.** Es el instrumento de cumplimiento de
`editorial/09-reglas-de-casos-ficticios.md`.

**Casos registrados a 2026-09-10: 13.**

**C-13 se registró el 2026-09-10, antes de escribirse (Etapa 3.17B), por autorización expresa del autor** y conforme a la propuesta razonada del preflight del capítulo 18. **Es el primer caso formal desde el capítulo 15**, y el motivo está escrito: los capítulos 16 y 17 enseñaban condiciones y lecturas, que una microescena muestra bien; **el 18 enseña un ciclo en el tiempo** —se transfiere, ocurre, se revisa, se clasifica, se decide— **y una microescena es una instantánea que no puede mostrar un ciclo**. Ninguno de los doce anteriores sirve: el más cercano, **C-07**, muestra un límite escrito repartiendo decisiones, que es el mecanismo del capítulo 10, y reutilizarlo habría borrado la frontera 10/18.
...
| C-11 | Inés (solo nombre de pila) | Mujer | **A** | Mantenimiento | 14 | Concede a una tarea —decidir en qué orden se hacen las revisiones preventivas del mes— permiso para proponerle qué hacer. La primera recomendación está bien escrita, trae sus datos y su regla, y **coincide con lo que ella ya había pensado**. Al comprobarla aparece lo que la recomendación no podía saber: ese equipo llevaba unas semanas trabajando en condiciones distintas, y **los partes registran horas, no condiciones**. | **Estar de acuerdo no es lo mismo que haber comprobado.** Es la encarnación del **sesgo de automatización sin caricatura**: no hay una persona crédula obedeciendo a una máquina, hay una propuesta que **confirma** lo que ya se pensaba, y una confirmación es justo lo que nadie verifica. Enseña además la respuesta que ningún capítulo había mostrado: **modificar** —ni aceptar ni rechazar—, y que el hallazgo de una recomendación puede no estar en la recomendación sino **en lo que el negocio no registra**. | Tres: (1) dirige una empresa de mantenimiento con varios técnicos; (2) planifica ella el orden de las revisiones desde siempre; (3) sus partes de trabajo recogen horas y no condiciones de uso. | Bajo | Sin apellido. Sin lugar. **Sin cifras, horas concretas, importes ni moneda** —los equipos se comparan por «menos» y «bastantes más»—. Sin fechas. Sin composición familiar. Sin número de técnicos. **Sin marca ni tipo de maquinaria, sin nombre ni sector del cliente**, y sin vocabulario de oficio. **La herramienta se llama «una herramienta» y no se nombra.** Construido desde el mecanismo hacia el ejemplo. |
| C-12 | Ismael (solo nombre de pila) | Hombre | **B** | Importación y distribución | 15 | Escribe un permiso de línea y media para una tarea que hacía él de noche —clasificar y archivar los documentos de cada envío— y durante semanas **deja de volver a decidir en cada caso**. Una noche llega **una versión corregida de un documento de un envío que ya había cerrado**: fuera del permiso escrito. La herramienta **no decide que sea un cambio pequeño, no archiva encima y no abre el envío por su cuenta**. Se detiene y le devuelve la decisión. | **Una excepción no concede autonomía: la retira.** Y el caso enseña algo que ningún capítulo anterior había podido mostrar: **el valor no está en que el sistema acierte, sino en que ante un caso distinto no improvise**. Enseña además la diferencia entre **autorizar una clase de acciones** y **aprobar cada ejecución**, y que **pasar de nivel no significa que la herramienta sea más lista: significa que cambió el permiso, porque una persona decidió cambiarlo**. | Tres: (1) importa y distribuye por su cuenta, sin empleados; (2) cada envío le genera varios documentos que llegan por separado y en momentos distintos; (3) los archivaba él, de noche. | Bajo | Sin apellido. Sin lugar. **Sin cifras, importes ni moneda** —«decenas de documentos», «unas semanas»—. Sin fechas concretas. Sin composición familiar. **Sin mercancía, sin origen, sin proveedor, sin cliente y sin vocabulario aduanero, fiscal o contable**: se dice «importa y distribuye» y nada más. **El documento corregido no se identifica como factura ni como ningún tipo concreto**, precisamente para no meter contabilidad en el mecanismo. **La herramienta se llama «una herramienta» en todo el capítulo.** Construido desde el mecanismo hacia el ejemplo. |
| C-13 | Beatriz (solo nombre de pila) | Mujer | **A** | Construcción | 18 | Autoriza personalmente **cualquier cambio que un cliente pide una vez empezado el trabajo**, y esa decisión vuelve siempre a ella. Transfiere un solo bloque —aceptar los cambios que no toquen el plazo comprometido ni el precio acordado— a quien coordina el trabajo, dentro del límite que ya tenía escrito. Al cabo de unas semanas **vuelven tres**: dos por el motivo previsto, porque tocaban el plazo; **el tercero por un motivo que el límite no contemplaba**, un cambio que no tocaba plazo ni precio pero exigía un material distinto del previsto. | **La clasificación va antes que la decisión, y aquí el resultado no fue un fallo de ejecución** (**D-079**): las dos primeras devoluciones son **el límite funcionando como estaba diseñado**, y la tercera es la **tercera clase** —el límite no estaba escrito de más, estaba **incompleto**—. **No hizo falta preguntar quién falló** —corregido el 2026-09-10 en el microcontrol 3.17B.1, porque «nadie hizo nada mal» afirmaba más de lo que el episodio demuestra y daba por evaluada la cuarta clase—: quien paró hizo exactamente lo que había que hacer, y **el examen encontró antes lo que estaba incompleto**. **Y enseña la disciplina que sostiene la progresividad:** la tentación era corregir el límite **y** ampliar el alcance a la vez; hacerlo habría dejado la revisión siguiente sin poder decir cuál de los dos cambios produjo lo que ocurriera. Corrigió el límite y **mantuvo** el bloque igual, que es una de las cuatro salidas y no un premio de consolación. | Tres: (1) dirige una empresa constructora pequeña con personas que coordinan los trabajos; (2) hasta ahora era ella la única frontera de esa decisión; (3) su límite escrito no decía nada sobre cambios de material. | Bajo | Sin apellido. Sin lugar. **Sin cifras, importes, plazos concretos ni moneda** —solo el recuento «tres», que es una cifra pedagógica de categoría B—. Sin fechas —solo «unas semanas»—. Sin composición familiar. Sin número de personas. **Sin tipo de obra, sin nombre de material, sin cliente identificable, sin marcas y sin vocabulario de oficio**: se dice «una empresa constructora pequeña» y «un trabajo ya empezado», y nada más. Construido desde el mecanismo hacia el ejemplo. |

**Riesgo de semejanza:** `bajo` · `medio` · `alto`.
Un caso calificado como **alto no se escribe**: se rediseña o se descarta.

## 2. Criterios de calificación del riesgo

| Nivel | Cuándo se asigna |
|---|---|
| Bajo | El caso describe un mecanismo general. Tres rasgos o menos, ninguno inusual. Sin lugar, sin cifras, sin fechas, sin composición familiar concreta. |
| Medio | Aparece alguna combinación poco común de sector, tamaño y situación, o un rasgo distintivo llamativo. Requiere rediseño de al menos un elemento antes de escribirse. |
| Alto | La combinación de rasgos podría señalar a una organización concreta, o el caso incluye un incidente singular, un lugar, cifras o una estructura familiar reconocible. No se escribe. |

## 3. Control de reparto por sector

Máximo tres apariciones por sector. Sin repetición en capítulos consecutivos.
...
| Mantenimiento | **1** | 7, **14** | **14** |
| Construcción | **1** (más una microescena sin nombre, cap. 7, **ruta B**) | 8, 23, **18** | **18** |
...
**Sectores del capítulo 15 y de la herramienta 12 (Etapa 3.14B): decididos en el preflight y
ejecutados sin cambios.**

| Pieza | Sector | Por qué |
|---|---|---|
| **Caso C-12, capítulo 15** | **Importación y distribución** | Cero apariciones de caso, y el sector **había perdido dos de sus tres turnos** —los capítulos 12 y 14— por coincidir con el ejemplo de la herramienta 9, que es **mujer y de ruta A**. **C-12 es hombre y de ruta B**, opuesto en los dos ejes, y aquel ejemplo queda a cuatro capítulos. Queda en **1 de 3** y conserva el capítulo 17 |
| **Ejemplo de la herramienta 12** | **Distribución regional** | **Ningún ejemplo de herramienta lo había usado**, en doce herramientas. Su único caso es **C-01, del capítulo 1**, catorce capítulos atrás, y el ejemplo **no usa nombre propio**: habla de «la responsable de almacén» como función, para no rozar a Elena |

**Una anotación de asignación que conviene dejar por escrito.** El sector previsto para el
capítulo 15 era **manufactura ligera**, y se descartó porque **el ejemplo de la herramienta 10 lo
usa dos capítulos atrás**, la distancia más corta de todo el libro. Y el sector que sí se usó,
importación y distribución, **no tenía asignado el capítulo 15**: sus turnos previstos eran 12, 14
y 17. **Es la primera vez que un sector entra en un capítulo que no figuraba en su lista**, y la
razón es acumulativa: se le apartó dos veces seguidas por una coincidencia que aquí no se da.
**Conserva el capítulo 17.**

**Reparto por ruta: 6 y 6.** **Reparto por género: 6 y 6.** Es la primera vez que los dos ejes
quedan exactamente equilibrados con doce casos, y la alternancia caso a caso **sigue sin romperse
ni una vez**: Elena, Andrés, Marta, Tomás, Lucía, Rafael, Pilar, Óscar, Nuria, Julián, Inés,
Ismael.

**Sector del capítulo 14 (Etapa 3.13B): mantenimiento, y NO el previsto.** Decidido en el
preflight de la Etapa 3.13A y ejecutado sin cambios. El capítulo 14 **no produce herramienta**
—su entregable vive dentro—, así que solo había un sector que asignar.

El previsto era **importación y distribución**. Se descartó por **la misma triple coincidencia
que movió el capítulo 12**: el ejemplo de la **herramienta 9** es **una mujer, de ruta A, en
importación y distribución**, y a C-11 le correspondían mujer y ruta A. A tres capítulos de
distancia en lugar de uno, pero la regla se aplica igual. **El sector conserva sus capítulos 14
y 17**; solo pierde el turno, y queda con dos capítulos para tres apariciones posibles.

**Mantenimiento no le cuesta nada a nadie:** cero apariciones de caso y su único capítulo
previsto, el 7, ya está escrito. Queda en **1 de 3**. Sin repetición consecutiva: el 13 fue
logística.

**La coincidencia anotada, real aunque lejana:** el ejemplo de la **herramienta 4** —capítulo 7,
siete capítulos atrás— transcurre en un taller de reparación de maquinaria. Se diferencia en
género, en escala y en decisión. Y de ahí salió **una restricción que el preflight impuso y el
capítulo respetó: C-11 no podía tratar de «aceptar un trabajo urgente»**, porque ese asunto lo
usan ya los ejemplos de las herramientas 4 y 8. Es la primera vez que el control de casos veta
**un mecanismo** y no un sector.

**Reparto por género: 6 mujeres y 5 hombres.** La alternancia caso a caso sigue sin romperse en
once casos. **Reparto por ruta: 6 de ruta A y 5 de ruta B.**
...
ejemplos de herramientas— **cambia una asignación en lugar de limitarse a anotar una
coincidencia**, y conviene dejar dicho por qué.

El capítulo 12 tenía asignada **importación y distribución**. Esa asignación no incumplía
ninguna regla: el sector tenía cero apariciones de caso y el capítulo 11 usó servicios técnicos,
así que tampoco había repetición consecutiva. Lo que había era una **coincidencia triple con el
ejemplo de la herramienta 9**, escrito una sola etapa antes: mismo sector, **misma ruta A** y
**misma protagonista mujer** —y, por la alternancia caso a caso, a C-09 le correspondía una
mujer—. Tres coincidencias a un capítulo de distancia es más de lo que el archivo estaba
dispuesto a registrar y dejar pasar.

**Se usa agricultura, que no le cuesta nada a nadie.** Tenía cero apariciones y tres permitidas,
y con esta queda en **1 de 3**, de modo que **conserva íntegros sus capítulos previstos 5 y 21**.
**Importación y distribución sigue en cero apariciones** y conserva los capítulos 14 y 17, con
más holgura que antes. **Sin repetición consecutiva:** el capítulo 11 fue servicios técnicos.

**La coincidencia que sí queda anotada, y es menor:** el ejemplo de la **herramienta 6** —del
capítulo 8, cuatro capítulos atrás— también transcurre en agricultura, igual que el de la
herramienta 2. No colisiona con ninguna regla y son escenas muy distintas, pero **agricultura
acumula ya dos ejemplos de herramienta y ahora un caso**: si los capítulos 5 o 21 la usan, será
la tercera y última aparición y conviene saberlo de antemano.

**El capítulo 12 no produce ninguna herramienta**, así que esta etapa no tuvo que asignar un
segundo sector: el cuadro vive dentro del capítulo y su única fila de ejemplo es la de Nuria.
...
repite la observación del capítulo anterior, y conviene que quede vista dos veces:** el ejemplo de
la **herramienta 5** también transcurre en alimentos. No incumple ninguna regla —los ejemplos de
las herramientas no cuentan como apariciones de caso— y son muy distintos, pero es el segundo
capítulo seguido en que el sector previsto coincide con el de una herramienta anterior. **La causa
está identificada:** la lista de sectores admitidos se repartió entre capítulos antes de que
existieran los ejemplos de las herramientas, y estos se asignaron después sin volver a la lista.
**Registrado para decisión del autor**, porque a partir del capítulo 11 conviene asignar el sector
de cada ejemplo mirando las dos listas a la vez. **Alimentos queda en 1 de sus 3 apariciones y
conserva el capítulo 25.** El ejemplo de la herramienta 8 se sitúa en **construcción**, distinto
del capítulo y distinto de los ejemplos de las herramientas 4, 5, 6 y 7.

**Sector del capítulo 9 (Etapa 3.8B): comercio minorista, el que tenía previsto.** El capítulo
8 usó importación y distribución, así que no hay repetición en capítulos consecutivos. Queda una
observación anotada, no un incumplimiento: **el ejemplo de la herramienta 3 también transcurre
en una tienda pequeña**, tres capítulos atrás. No colisiona con ninguna regla —los ejemplos de
las herramientas no cuentan como apariciones de caso— y los dos son distintos en escala, ruta y
decisión: aquel es un negocio con dos empleadas de ruta A que decide sobre mercancía defectuosa;
este es una persona sola de ruta B que decide sobre apartar un artículo. Se registra para que la
coincidencia no pase inadvertida al revisar la parte. **Comercio minorista queda en 1 de sus 3
apariciones y conserva el capítulo 22.** El ejemplo de la herramienta 7 se sitúa en **logística**,
distinto del capítulo y distinto de los ejemplos de las herramientas 4, 5 y 6.
...
final, porque corregirlo al final obliga a reescribir muchos pasajes.

| | Casos | Porcentaje |
|---|---|---|
| Protagonistas mujeres | 6 | **50 %** |
| Protagonistas hombres | **6** | **50 %** |
| Sin género especificado | 0 | — |

**Nota de la Etapa 3.14B.** Con C-12 el reparto vuelve a **6 a 6**, y con doce casos **los dos ejes quedan exactamente equilibrados por primera vez**. Sin deuda.

**Nota de la Etapa 3.13B.** Con C-11 el reparto quedaba **6 a 5**. Con once casos el desequilibrio de uno es inevitable y **no crea deuda**.

**Nota de la Etapa 3.12B.** Con C-10 el reparto volvía a **5 a 5**, y la alternancia caso a caso **no se ha roto ni una vez en diez casos**. Sin deuda.
...
Lucía, Rafael, Pilar. **No se crea ninguna deuda.**

**Nota de la Etapa 3.8B.** Con C-06 el reparto queda **3 a 3**, equilibrado. El capítulo 9 no
eligió hombre por cuota: eligió el caso por lo que el capítulo necesitaba —una persona que
trabaja sola, cuyo criterio nunca se le ha pedido explicar— y el equilibrio salió de paso. Se
vuelve a revisar al cerrar la Parte II.

**Nota anterior (cinco casos).** Con cinco casos el reparto quedaba 3 a 2. La alternancia se ha
...
Regla de `14-publico-y-rutas.md`, apartado 5: **ningún capítulo puede tener todos sus
ejemplos de una sola ruta** cuando el mecanismo se manifieste de forma distinta en cada
escala.

| | Casos | Capítulos |
|---|---|---|
| Ruta A — empresa con estructura | 6 | 1, 2, 3, 10, 12, 14 |
| Ruta B — profesional independiente | **6** | 1, 4, 9, 11, 13, **15** |

**Reparto a 2026-09-09, tras el capítulo 15: 6 a 6.** El caso del capítulo 15 es de **ruta B** y alterna con el 14, que era de ruta A. **La ruta A se atiende dos veces dentro del capítulo**: con un pasaje sobre cómo se reparten autorizar, operar y revisar cuando hay funciones distintas —**sin exigir tres personas ni inventar cargos**— y con el **ejemplo de la herramienta 12**, que es de ruta A, de otro sector y **sin nombre propio**.

**Reparto anterior, tras el capítulo 14: 6 a 5.** El caso del capítulo 14 es de **ruta A** y alterna con el 13, que era de ruta B. **La ruta B se atiende dentro del capítulo con un pasaje breve y explícito**: quien recibe la propuesta y quien decide pueden ser la misma persona, **y eso no se disfraza de nada** —no hay «autoaprobación», hay una persona decidiendo—. Lo que se conserva en las dos rutas es la separación entre **propuesta** y **decisión**. El capítulo **no produce herramienta**, así que esa vía de compensación no estaba disponible.

**Reparto anterior, tras el capítulo 13: 5 a 5.** El caso del capítulo 13 es de **ruta B** y alterna con el 12, que era de ruta A. **Y esta vez la otra ruta no se atiende con un pasaje breve, sino con tres cosas:** una sección propia del capítulo sobre cómo cambia la revisión cuando hay equipo, **y los ejemplos de las dos herramientas, los dos de ruta A y de sectores distintos entre sí y del capítulo**. Ninguna de las dos rutas queda sin manifestación concreta, y ninguna se lleva el capítulo entero.
...
con el **ejemplo de la herramienta 7**, que es de ruta A y de otro sector. Ninguna de las dos
rutas queda sin manifestación concreta.
...
conocimiento que nunca se escribió porque nunca pareció conocimiento es exactamente el mismo
fenómeno con equipo y sin él, así que el principio se enuncia una vez. **La ruta B se
atiende dentro de la argumentación**, con ejemplos breves intercalados y con la cita de
Nonaka sobre el maestro artesano que no sabe explicar lo que sabe, que no supone
organización alguna. Reparto acumulado tras el capítulo 2: dos casos de ruta A y uno de
ruta B.

**Aviso de holgura.** «Servicios profesionales» llega con este caso a sus tres apariciones
previstas (1, 4 y 20). Es el sector natural de la ruta B, y la lista admitida de
`09-reglas-de-casos-ficticios.md` se diseñó antes de la ampliación del público. Si los
capítulos de la ruta B necesitan más ejemplos, habrá que ampliar la lista de sectores
admitidos o reasignar el caso del capítulo 20. Registrado para decisión del autor.
...
1. ¿Menciona un sector excluido, o algún proceso, vocabulario o unidad propios de él?
2. ¿Menciona una ciudad, región o país?
3. ¿Contiene cifras monetarias, de plantilla o de facturación?
4. ¿Contiene fechas o periodos concretos?
5. ¿Describe una composición familiar identificable?
6. ¿Acumula más de tres rasgos distintivos en una persona?
7. ¿Narra un incidente singular con detalles que lo hagan único?
8. ¿Procede de información privada, de un documento interno o de una conversación real?
