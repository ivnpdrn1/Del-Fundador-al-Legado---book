...
Definiciones que el libro usa con significado fijo. Cada término se define en el
manuscrito la primera vez que aparece, con una frase comprensible sin formación técnica,
y esa definición debe coincidir con la de este archivo.

**Regla:** si un término no puede definirse aquí en una frase clara, no se usa en el
libro.

**Columna "Cap.":** capítulo donde el término se introduce por primera vez.
...
| ADN Empresarial | Conjunto de conocimiento, experiencia, criterio, decisiones, relaciones y formas de trabajar que hacen que un negocio funcione de la manera particular en que funciona. **No hace falta tener una sociedad ni empleados para tenerlo:** aquí «empresarial» significa «de la actividad económica». Propuesta propia de este libro. | Intro |
| Clonación del ADN Empresarial | Proceso de identificar, capturar, estructurar, preservar y transferir el ADN Empresarial hacia personas, procedimientos, sistemas y herramientas capaces de asistir, recomendar y ejecutar bajo niveles definidos de supervisión. **Propuesta propia de este libro, no un término académico.** No significa clonar a una persona. En inglés, *Business DNA Cloning*. | Intro |
| Clonación del conocimiento | La parte de la clonación del ADN Empresarial que se ocupa del conocimiento propiamente dicho. **Dejó de ser el concepto paraguas del libro el 2026-09-07 (D-043).** Se usa solo cuando el pasaje trate específicamente de capturar o transferir conocimiento. | 2 |
| Gemelo de IA | Sistema de inteligencia artificial construido sobre una representación estructurada del ADN Empresarial, capaz de recuperar conocimiento, aplicar reglas, reconocer patrones, asistir decisiones y escalar a una persona lo que le corresponde. **No es una réplica de nadie, no tiene identidad propia y no es obligatorio.** En inglés, *AI Twin*. | 15 |
| Legado Inteligente | Estado de un negocio cuyo conocimiento, experiencia y criterio críticos han dejado de depender exclusivamente de la memoria y la presencia de una sola persona, y pueden seguir usándose bajo transferencia, control y supervisión apropiados. **No es inmortalidad digital ni conciencia artificial.** En inglés, *Intelligent Legacy*. | 25 |
...
| Término | Definición | Cap. |
|---|---|---|
| Matriz de autoridad | Documento que fija quién puede decidir qué, hasta qué límite y quién lo revisa. | 10 |
| Separación de funciones | Principio por el cual quien inicia una operación no es quien la aprueba ni quien la registra. | 10 |
| Delegar | Transferir una decisión y la autoridad para tomarla, con límites escritos y evidencia del resultado. No es repartir tareas. | 18 |
| Supervisar | Vigilar el resultado sin intervenir en la ejecución. | 20 |
| Registro de auditoría | Constancia de quién hizo qué, cuándo y con qué autorización. | 16 |
| Control | Mecanismo que reduce la probabilidad o el impacto de un error o de un abuso. | 10 |
| Tablero del propietario | Conjunto reducido de indicadores que permite a quien no está en la operación saber cómo va la empresa. | 19 |
...
| Transición | Periodo durante el cual la dependencia se traslada de una persona a un sistema de personas, procesos y tecnología. | 23 |

---

**Mantenimiento.** Cada vez que un capítulo introduzca un término nuevo, se añade aquí en
el mismo bloque de trabajo. En la Etapa 4 se comprueba que ninguna definición del
manuscrito contradiga a este archivo.
