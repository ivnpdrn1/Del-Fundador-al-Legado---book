...
| 3 | Que su equipo parece autónomo solo cuando él está | Tres respuestas del equipo | Prueba de las tres preguntas | Contraste percepción/realidad | Recoger respuestas de terceros y compararlas con las del propietario | Comparar y señalar divergencias | L |
| 4 | Qué se detiene, qué se pierde y qué no se recupera | Lista de lo que se detiene, con tiempos | Cálculo del costo de una semana | **Mapa de riesgos de ausencia** | Registrar y priorizar por impacto | Sugerir puntos no considerados a partir del ADN ya capturado | L |
| 5 | Que retirarse no es abandonar; el continuo del retiro | Posición deseada en el continuo + horizonte | 2. Cuestionario de preparación para el retiro | **Objetivo y horizonte del usuario** | **Módulo 0**: fijar el destino, que condiciona todo lo demás | Ninguna | L |
